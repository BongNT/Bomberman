...
public class Sprite {
    ...
    /**
     * tạo ra 1 ảnh mới = input * scaleFactor.
     *
     * @param input       ảnh bé cắt ra từ ảnh 256 ban đầu
     * @param scaleFactor độ phóng đại
     * @return ảnh đã phóng to
     */
    private Image resample(Image input, int scaleFactor) {
		...
		/*
			lấy màu từ 1 pixel tạo hình vuông với độ dài là scaleFactor
		 */
        for (int y = 0; y < H; y++) {
            for (int x = 0; x < W; x++) {
