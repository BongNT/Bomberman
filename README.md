...
- biểu đồ lớp thiết kế [tại đây](res/bomberman.uml).
...
- ![](res/sprites/oneal_left1.png) *Oneal* có tốc độ di chuyển nhanh hơn Balloom, sau 2s tự động chuyển hướng.
- ![](res/sprites/doll_left1.png) *Doll* thay đổi, lúc nhanh, lúc chậm hơn so với Balloom.
